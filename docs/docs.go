...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_levchenki_tea-api_internal_schemas_unitSchemas.ResponseModel"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_levchenki_tea-api_internal_schemas_unitSchemas.RequestModel"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_levchenki_tea-api_internal_schemas_unitSchemas.RequestModel": {
            "type": "object",
            "properties": {
                "isApiece": {
                    "type": "boolean"
        ...
        "github_com_levchenki_tea-api_internal_schemas_unitSchemas.ResponseModel": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
